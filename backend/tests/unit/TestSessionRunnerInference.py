...
class TestSessionRunnerPassesFrameToPredictor:
    ...
    async def test_tick_passes_frame_as_bgr_frame(self):
        ...
        with patch("app.core.RedisStreamBus.publish", return_value=None), \
             patch("ml.xai.NlExplainer.generate_explanation", return_value=""):
